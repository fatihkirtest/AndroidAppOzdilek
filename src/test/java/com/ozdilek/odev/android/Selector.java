...
public class Selector {
    ...
    public static String EMAIL = "zikzak09876@outlook.com";
    public static String PASSWORD = "zakzik67890";
    public static By BACK_TO_PAGE = By.id("com.ozdilek.ozdilekteyim:id/ivBack");
    public static By ADD_BASKET = By.id("com.ozdilek.ozdilekteyim:id/relLayAddFav");
